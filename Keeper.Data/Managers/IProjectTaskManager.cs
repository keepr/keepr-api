...
namespace Keeper.Data.Managers
{
    public interface IProjectTaskManager
    {
        ...
        public Task<ProjectTask> CreateAsync(string name, string description, double? hours, DateTimeOffset? date, int projectId, int userId);
        ...
        public Task<ProjectTask> UpdateAsync(int id, string name, string description, double? hours, DateTimeOffset? date, int userId);
